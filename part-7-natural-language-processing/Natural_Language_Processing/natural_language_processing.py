...
# 0
# 1
# (0,0) number of correct negative predictions
# (1,1) number of correct positive predictions
# (0,1) number of incorrect positive predictions
# (1,0) number of incorrect negative predictions

# 146 correct and 54 incorrect predictions ~73% accuracy - pretty good for 800 training set
print(cm)
